...
def convert_from_AM_to_IM(graph):
    """Converts the given graph with its data, from the Adjacency Matrix representation to Incidence Matrix representation.
        graph - Graph object"""
...
def convert_from_IM_to_AM(graph):
    """Converts the given graph with its data, from the Incidence Matrix representation, to Adjacency Matrix representation.
        graph - Graph object"""
...
def convert_from_AM_to_AL(graph):
    """Converts the given graph with its data, from the Adjacency Matrix representation, to Adjacency List representation.
        graph - Graph object"""
...
def convert_from_AL_to_AM(graph):
    """Converts the given graph with its data, from the Adjacency List representation, to Adjacency Matrix representation.
        graph - Graph object"""
...
def convert_from_IM_to_AL(graph):
    """Converts the given graph with its data, from the Incidence Matrix representation, to Adjacency List representation.
        graph - Graph object"""
...
def convert_from_AL_to_IM(graph):
    """Converts the given graph with its data, from the Adjacency List representation, to Incidence Matrix representation.
        graph - Graph object"""
...
"""Dictionary object which maps the representation strings to their proper conversion functions."""
...
def convert_graph_representation(graph, new_representation):
    """Checks the representation of a graph and converts it to the representation passed as an argument using proper conversion function.
        graph - Graph object
        new_representation - the representation to which the graph will be converted"""
